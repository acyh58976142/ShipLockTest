...
public class CommonTool
{
	 ...
	 * yyyy/MM/dd HH:mm
	 */
	public static final SimpleDateFormat FORMAT_yyyyMMdd_HH_mm = new SimpleDateFormat("yyyy/MM/dd HH:mm");
	/**
	 * yyyy-MM-dd
	 */
	 ...
	 * @return
	 */
	public static String characterFormattingStr(Object obj)
	{
		if(obj == null || obj.toString().isEmpty() || obj.toString().equals(""))
		{
			return "";
	...
	public static void main(String[] args)
	{
		...
		// BillingRecord c = new BillingRecord();
		// c.setBillId("ssssssssssssssssssssss");
		// Map<String, Object> a = objectToMap(c);
		// System.out.println(a.get("billId"));
		// BillingRecord d = new BillingRecord();
		// mapToObject(a,d);
		// System.out.println(d.getBillId());
